...
var numcase = 0
        data.forEach(function afficheNote(variable) {
            if(numcase % 2 == 0) {
                document.querySelector('.liste-analogies').innerHTML += "<section class=\"sec\"><h3> Si jՎtais <div class=\"analogies\">" + variable.analogies + "</div> <h3>, je serais... " + "</h3>" + "<h2>" + variable.valeursAnalogies + "</h2>" +"<div class=\"flex-left\"> <img class="+variable.class+" src= "+variable.img+"><p class= 'texte_d'>"+ variable.justify+"</p></section></div>" ;
            } else {
                document.querySelector('.liste-analogies').innerHTML += "<section class=\"sec\"><h3> Si jՎtais " + variable.analogies + ", je serais... " + "</h3><h2>" + variable.valeursAnalogies + "</h2> <div class=\"flex-right\"> <img class="+variable.class+" src= "+variable.img+"><p class= 'texte_g'>"+ variable.justify+"</p></section></div>" ;
            } numcase = numcase + 1
})
